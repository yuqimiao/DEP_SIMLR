...
simu_tib =tibble(scenario = 1:3,
                 n_feat1 = c(1000, 1000, 10000),
                 n_feat2 = c(10000, 100000, 100000)) %>%
...
data1 = get_data_4clust(n_feat = n_feat1, mu_vec = mu1,s2n_ratio = s2n)
data2 = get_data_4clust(n_feat = n_feat2, mu_vec = mu2,s2n_ratio = s2n)
